...
- [**`briefing-hermit`**](plugins/briefing-hermit/README.md) — *For news/trending briefings.* Curated source registry, fetch/score/write pipeline, weekly synthesis, source-health analytics.
