...
See [Always-On Setup](plugins/claude-code-hermit/docs/always-on.md) for the Docker guide, and [Always-On Operations](plugins/claude-code-hermit/docs/always-on-ops.md) for the bare-tmux path and the lifecycle reference.
