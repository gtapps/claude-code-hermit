...
| `source`   | enum     | `manual`, `auto-detected`, `operator-request`               | How the proposal originated                                                   |
| `session`  | string   | `S-NNN`                                                     | Session where proposal was created. Optional for `operator-request` proposals |
