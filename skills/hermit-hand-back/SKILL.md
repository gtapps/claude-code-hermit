...
Check that the container started: run `docker compose ps --status running` after a few seconds.

- If running: confirm success
- If not running: warn "Container didn't start — check `docker compose logs` for errors."
