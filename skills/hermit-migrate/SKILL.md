...
- **Machine-specific fields** (must be updated on destination): `timezone`, `channels.*.state_dir`, `channels.*.dm_channel_id`, `tmux_session_name`, `permission_mode` — see `docs/config-reference.md` for any fields added since this list was written
