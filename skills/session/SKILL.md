...
Start or resume a session with full context loading. This is the generic session workflow — hermit agents may provide specialized versions (e.g., `/claude-code-dev-hermit:dev-session` for software development with code review and testing).
