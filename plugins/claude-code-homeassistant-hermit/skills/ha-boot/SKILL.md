...
2. Check your auto memory for the stored language. All user-facing output should use this locale.
...
- No language in auto memory: ask the operator for their preferred locale.
