...
| Crash recovery   | `restart: unless-stopped` auto-restarts on crash and reboot   | `bin/hermit-watchdog install` registers a systemd user timer, LaunchAgent, or cron job that restarts it |
